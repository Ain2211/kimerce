    ...
    <div class="card">
      <div class="card-header card-header-flex">
        ...
        <div class="d-flex flex-column justify-content-center">
          <router-link :to="{path:'/NewsCreateOrUpdate/0'}">

            <a-button class="btn btn-primary" type="primary" icon="plus">Tạo blog</a-button>
          </router-link>
        </div>
      </div>
      <div class="card-body">
        <div class="air__utils__scrollTable">
          <a-table :columns="columns"
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <button @click="del(record)" class="btn btn-sm btn-light">
                <small>
                  <a-icon type="delete" />
                </small>
                Remove
              </button>
              <router-link :to="{name:'NewsCreateOrUpdate', params: { id: record.id }}" class="btn btn-sm btn-light">
                <small>
                  <a-icon type="edit" />
                </small>
                Edit
