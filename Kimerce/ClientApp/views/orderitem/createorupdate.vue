  ...
  export default {
    created() {
      Axios.get("https://localhost:44397/orderitems/Getbyid/" + this.$route.params.id).then(r => {
        this.Model.IdProduct = r.data.idOrder;
        this.Model.IdOrder = r.data.idProduct;
    ...
    methods: {
      CreateForm() {
        let options = {
          mapPropsToFields: () => {
            return {
              IdProduct: this.$form.createFormField({ value: this.Model.IdProduct, }),
              IdOrder: this.$form.createFormField({ value: this.Model.IdOrder, }),
      ...
      GetModel() {
        this.Model.IdProduct = this.Form.getFieldValue('IdProduct');
        this.Model.IdOrder = this.Form.getFieldValue('IdOrder');
      ...
      Reset() {
        Axios.get("https://localhost:44397/orderitems/getbyid/" + this.$route.params.id).then(r => {
          this.Form.setFieldsValue({
            IdProduct : r.data.idOrder,
        IdOrder : r.data.idProduct,
